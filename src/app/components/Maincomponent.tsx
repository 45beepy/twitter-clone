...
const MainComponent = () => {
  return (
    <main className="flex w-[700px] h-full min-h-screen flex-col border-l-[0.5px] border-r-[0.5px] border-gray-600">
      {/* Home header */}
        ...
        <div className="flex-1 flex flex-col">
          ...
          <div className="flex items-center justify-between mt-4">
            <div className="flex items-center space-x-4">
              <div className="text-blue-500 cursor-pointer hover:bg-blue-100 hover:bg-opacity-10 p-2 rounded-full">
                <RiImageLine size={28} />
              </div>
              
              <div className="text-blue-500 cursor-pointer hover:bg-blue-100 hover:bg-opacity-10 p-2 rounded-full">
                <MdOutlineGif size={28} />
              </div>
            ...
            <button className="bg-blue-500 hover:bg-blue-600 transition-colors text-xl text-white font-bold rounded-full px-4 py-2 w-44 ">
              Tweet
            </button>
          </div>
          ...
          <div key={i} className="px-4 py-6 flex space-x-4 hover:bg-gray-800 transition-colors duration-200 cursor-pointer">
            ...
            <div className="flex flex-col space-y-2 w-full">
              ...
              <div className="text-white text-lg ">
                ...
                <p className="mt-1">
                  Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iure deserunt fugit id autem mollitia vero cum officia animi ipsa.Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iure deserunt fugit id autem mollitia vero cum officia animi ipsa.
                </p>
              </div>
